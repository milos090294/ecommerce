                            ...
                            <div class="payment_method">
                                ...
                                <div class="payment_option mb-20">
                                    ...
                                    <div class="custome-radio">
                                        <input wire:model="payment_option"  type="radio" value="Paypal" /> Paypal
                            ...
                            <div class="table-responsive order_table text-center">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Ukupno</th>
                                            <td class="product-subtotal" colspan="2">BAM {{Cart::instance('cart_'.session()->getId())->subtotal()}}</td>
                                        </tr>
                                        <tr>
                                            <th>PDV</th>
                                            <td class="product-subtotal" colspan="2">BAM {{Cart::instance('cart_'.session()->getId())->tax()}}</td>
                                        </tr>
                                        <tr>
                                            <th>Poštarina</th>
                                            <td colspan="2"><em>BAM 8</em></td>
                                        </tr>
                                        <tr>
                                            <th>Total</th>
                                            <td colspan="2" class="product-subtotal"><span class="font-xl text-brand fw-900">BAM {{Cart::instance('cart')->total() + 8}}</span></td>
                                        </tr>
