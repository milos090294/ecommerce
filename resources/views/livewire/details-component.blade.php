                ...
                <div class="row">
                                    ...
                                    <div class="detail-info">
                                       ...
                                       {{-- <div class="product_sort_info font-xs mb-30">
                                        ...
                                        <div class="attr-detail attr-color mb-15">
                                            {{-- <strong class="mr-10 bg-success text-white" style="font-size: 14px; border-radius: 5px; padding: 5px 150px">Brza Dostava</strong> --}}
                                        ...
                                        <div class="attr-detail attr-size">
                                            <strong class="mr-10">Veličina</strong>
                                            <div class="select-wrapper">
                                                <select wire:model.defer="size" class="styled-select">
                            ...
                            <div class="row mt-60">
                                ...
                                <div class="col-12">
                                    <div class="row related-products">
                                        @foreach ($rproducts as $r_product)
                                            ...
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="{{route('product.details', ['slug' => $r_product->slug])}}" tabindex="0">
                                                            <img class="default-img" src="{{ asset('assets/imgs/products')}}/{{$r_product->image}}" alt="{{$r_product->name}}">
                                                           
                                                        </a>
                                                    </div>
                                                    {{-- <div class="product-action-1">
                                                       
                                                        <a aria-label="Dodaj u Listu Želja" class="action-btn small hover-up" wire:click.prevent = "addToWishList({{$product->id}}, '{{$product->name}}', {{$product->regular_price}})" tabindex="0"><i class="fi-rs-heart"></i></a>
                                                ...
                                                <div class="product-content-wrap">
                                                    <h2><a href="{{route('product.details', ['slug' => $r_product->slug])}}" tabindex="0">{{$r_product->name}}</a></h2>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            @foreach ($nproducts as $n_product)
                                
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="{{ asset('assets/imgs/products')}}/{{$n_product->image}}" alt="{{$n_product->name}}">
                                </div>
