    ...
    <main class="main">
                        ...
                        <div class="row align-items-center slider-animated-1">
                            <div class="col-lg-5 col-md-6">
                                <div class="hero-slider-content-2">
                                    ...
                                    <a class="animated btn btn-brush btn-brush-3" href="{{ $slide->link }}"> Buy
                                        Now! </a>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-6">
                                <div class="single-slider-img single-slider-img-1">
                                    <center><img class="animated slider-1-1"
                                            src="{{ asset('assets/imgs/slider') }}/{{ $slide->image }}"
                                            alt="{{ $slide->sub_title }}"></center>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                        <div class="banner-features wow fadeIn animated hover-up">
                            ...
                            <h4 class="bg-1">Free and Safe Delivery</h4>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                        <div class="banner-features wow fadeIn animated hover-up">
                            <img src="assets/imgs/theme/icons/feature-2.png" alt="">
                            <h4 class="bg-3">Online buy</h4>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                        <div class="banner-features wow fadeIn animated hover-up">
                            <img src="assets/imgs/theme/icons/feature-3.png" alt="">
                            <h4 class="bg-2">Safe Payment</h4>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                        <div class="banner-features wow fadeIn animated hover-up">
                    ...
                    <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                        <div class="banner-features wow fadeIn animated hover-up">
                            ...
                            <h4 class="bg-5">Happy Customers</h4>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 mb-md-3 mb-lg-0">
                        <div class="banner-features wow fadeIn animated hover-up">
                ...
                <div class="tab-header">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        {{-- <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="nav-tab-one" data-bs-toggle="tab" data-bs-target="#tab-one"
                                type="button" role="tab" aria-controls="tab-one" aria-selected="true"
                                onclick="scrollToForm('#featured')">Featured</a>
                        </li> --}}
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="nav-tab-two" data-bs-toggle="tab" data-bs-target="#tab-two"
                                type="button" role="tab" aria-controls="tab-two" aria-selected="false"
                                onclick="scrollToForm('#popular')">Popular Categories</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="nav-tab-three" data-bs-toggle="tab" data-bs-target="#tab-three"
                                type="button" role="tab" aria-controls="tab-three" aria-selected="false"
                                onclick="scrollToForm('#new-added')">Latest Items</a>
                        </li>
                    </ul>
                                ...
                                <div class="product-cart-wrap mb-30">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-action-1 show">
                                            <a wire:click.prevent="store({{ $fproduct->id }}, '{{ $fproduct->name }}', {{ $fproduct->regular_price }})"
                                                aria-label="Add To Cart" class="action-btn hover-up" href="#"><i
        ...
        <section class="banner-2 section-padding pb-0">
            <div class="container">
                <div class="banner-img banner-big wow fadeIn animated f-none">
                    <img src="assets/imgs/banner/banner.png" alt="">
                    <div class="banner-text d-md-block d-block">
                        <h4 class="mb-15 mt-40 text-brand sm-d-none">Carefree shopping</h4>
                        <h1 class="fw-400 mb-20 ">Your safety is <br> our responsibility! <br> </h1>
                        <a href="{{ route('shop') }}" class="btn"> Buy Now! <i class="fi-rs-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </section>
        <section id="popular" class="popular-categories section-padding mt-25 mb-25">
        ...
        <section class="section-padding">
            <div id="new-added" class="container wow fadeIn animated">
                <h3 class="section-title mb-20"><span>Latest</span> Items</h3>
                <div class="carausel-6-columns-cover position-relative">
        ...
        <section class="section-padding">
            <div class="container">
                <h3 class="section-title mb-20 wow fadeIn animated"><span>Client </span> experiences</h3>
                <div class="carausel-6-columns-cover position-relative wow fadeIn animated">
                    ...
                    <div class="carausel-4-columns text-center" id="carausel-6-columns-3">
                        <div class="brand-logo">
                            <p>"I am delighted with the speed of delivery and the careful packaging of the product.
                                Everything arrived undamaged and within the time they promised." - <span
                                    id="customer">Katarina</span></p>
                        </div>
                        <div class="brand-logo">
                            <p>"I have nothing but words of praise for their customer support. They were very kind and
                                patient, they answered all my questions and solved a problem with one of my orders in
                                record time.." - <span id="customer">Milica</span></p>
                        </div>
                        <div class="brand-logo">
                            <p>"The quality of the product I received is outstanding! They look even better than in the
                                pictures. I will definitely recommend them to everyone!" - <span
                                    id="customer">Radana</span></p>
                        </div>
                        <div class="brand-logo">
                            <p>"Their website is very intuitive and easy to use. Finding the product, adding it to the
                                cart and the purchase process were very fast. As for the delivery, everything went
                                well." - <span id="customer">Dada</span></p>
                        </div>
                        <div class="brand-logo">
                            <p>"Communication was excellent. I made the purchase relatively easily, and I am a loyal
                                customer from now on." - <span id="customer">Mika</span></p>
                        </div>
                        <div class="brand-logo">
                            <p>"I found myself in a problem when the product was brought to me and I didn't like it
                                then. I exchanged the product for another one without any problems, and they even
                                offered to refund my money if I didn't like the other products. Kudos, really." - <span
                                    id="customer">Tanja</span></p>
                        </div>
                        <div class="brand-logo">
                            <p>"The experience of shopping with them was extraordinary! Their wide range of products met
                                all my needs, and their prices delighted me. Also, fast delivery and excellent customer
                                support make them the first choice for online shopping. I will definitely be back and
                                recommend them to all my friends!" - <span id="customer">Divna</span></p>
                        </div>
                    </div>
                </div>
            </div>
