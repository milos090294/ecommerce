        ...
        <section class="mt-50 mb-50">
            <div class="container">
                <div class="row product-grid-4"> 
                    ...
                    @foreach (Cart::instance('wishlist'.session()->getId())->content() as $item)
                    <div class="col-lg-3 col-md-3 col-6 col-sm-6">
                        <div class="product-cart-wrap mb-30">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="{{ route ('product.details', ['slug' => $item->model->slug] ) }}">
                                        ...
                                        {{-- <img class="hover-img"  src="{{ asset('assets/imgs/shop/products')}}/{{$item->model->image}}" alt="{{$item->model->name}}"> --}}
                                    </a>
                                </div>
                            ...
                            <div class="product-content-wrap">
                                ...
                                <h2 class="mt-2"><a href="{{ route ('product.details', ['slug' => $item->model->slug] ) }}">{{$item->model->name}}</a></h2>
